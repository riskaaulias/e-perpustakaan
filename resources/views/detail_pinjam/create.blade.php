              ...
              <div class="row">
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route ('detail_pinjam.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <option value="{{ $data->id }}">{{ $data->total_pinjam}}</option>
                       @endforeach
                  </select>
                </div>
              </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="date" class="form-control" placeholder="Maksimal Pinjam" name="maks_pinjam"/>
                            </div>
