...
>
  <head>
    ...
    <title>Edit Data Pengembalian | E-perpustakaan</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tambah/</span>Pengembalian</h4>
              ...
              <div class="row">
                <div class="col-xxl">
                  <div class="card mb-4">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <select class="form-select" name="id_anggota">
                              @foreach($anggota as $data)
                                <option value="{{ $data->id }}" {{$data->id == $pengembalian->id_anggota ? 'selected' : ''}}>{{ $data->nama_anggota}}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
                    ...
                    <option value="{{ $data->id }}" {{$data->id == $pengembalian->id_petugas ? 'selected' : ''}}>{{ $data->nama_petugas }}</option>
                       @endforeach
                  </select>
                </div>
              </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="date" class="form-control" value="{{$pengembalian->tgl_pinjam}}" name="tgl_pinjam"/>
                            </div>
                         ...
                         <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span class="input-group-text"><i class="bx bx-calendar"></i></span>
                              <input type="text" class="form-control" value="{{$pengembalian->kode_buku}}" name="kode_buku"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span class="input-group-text"><i class="bx bx-collection"></i></span>
                              <input type="number" class="form-control" value="{{$pengembalian->tgl_kembali}}" name="tgl_kembali"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span class="input-group-text"><i class="bx bx-collection"></i></span>
                              <input type="number" class="form-control" value="{{$pengembalian->status}}" name="status"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span class="input-group-text"><i class="bx bx-collection"></i></span>
                              <input type="number" class="form-control" value="{{$pengembalian->jumlah_kembali_buku}}" name="jumlah_kembali_buku"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span class="input-group-text"><i class="bx bx-collection"></i></span>
                              <input type="number" class="form-control" value="{{$pengembalian->denda}}" name="denda"/>
                            </div>
