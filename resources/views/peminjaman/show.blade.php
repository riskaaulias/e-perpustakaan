...
>
  <head>
    ...
    <title>Detail Peminjaman | E-perpustakaan</title>
                    ...
                    <div class="card-body">
                      @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="text" class="form-control" name="id_anggota" value="{{$peminjaman->anggota->nama_anggota}}" disabled/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="text" class="form-control" name="id_petugas" value="{{$peminjaman->petugas->nama_petugas}}" disabled/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="text" class="form-control"  name="total_pinjam" value="{{$peminjaman->total_pinjam}}" disabled/>
                            </div>
                          </div>
                        </div>
